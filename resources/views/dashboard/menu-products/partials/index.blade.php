...
@section('container')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-5">
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 ">
            ...
            <div class="relative">
                ...
                <input type="text" id="table-search"
                    class="block p-2 ps-10 text-sm text-gray-900 border-1 border-gray-400 rounded-lg w-80 bg-gray-50 focus:border-blue-500"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            <li>
                                <a href="/products/create"
                                    class="flex flex-row items-center space-x-3 px-4 py-2 hover:bg-gray-200">
                            ...
                            <li>
                                <a href="#" class="flex flex-row items-center space-x-3 px-4 py-2 hover:bg-gray-200">
                                    <svg class="w-4 h-4 text-gray-600 dark:text-white" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                            ...
                            <li>
                                <button type="button" onclick="openDeleteAllModal()"
                                    class="w-full flex flex-row items-center space-x-3 px-4 py-2 hover:bg-red-100 hover:text-red-900">
        ...
        @include('dashboard.menu-products.partials.table')
    </div>

    <!-- Upload & Delete Modal -->
    @include('dashboard.menu-products.partials.upload-modal')
    @include('dashboard.menu-products.partials.delete-all-modal')
    @include('dashboard.menu-products.partials.delete-modal')


    {{-- ini adalah bagian untuk menampilkan SUCCESS ALERT & ERROR ALERT --}}
    @if (session()->has('success'))
        @include('dashboard.menu-products.partials.alert-success')
    @endif
    @if (session()->has('importError'))
        @include('dashboard.menu-products.partials.alert-error')
    @endif
