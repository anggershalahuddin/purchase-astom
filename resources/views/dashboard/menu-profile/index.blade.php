        ...
        <form action="#">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="brand" id="brand" value="{{ old('email', Auth::user()->email) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="example@gmail.com">
                </div>
                <div>
                    <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone</label>
                    <input type="text" name="brand" id="brand" value="{{ old('phone', Auth::user()->phone) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="example@gmail.com">
                </div>
                <div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="description" rows="5"
                        ...
                        placeholder="Your Address Here...">{{ old('address', Auth::user()->address) }}</textarea>
                </div>
            </div>
