            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="cust_code" name="cust_code"
                        ...
                        placeholder="" autofocus value="{{ old('cust_code', $material->cust_code) }}">
                    @error('cust_code')
                ...
                <div>
                    ...
                    <input type="text" id="ai_code" name="ai_code"
                        ...
                        placeholder="" autofocus value="{{ old('ai_code', $material->ai_code) }}">
                    @error('ai_code')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
                ...
                <div>
                    ...
                    <input type="text" id="cust_name" name="cust_name"
                        ...
                        placeholder="" autofocus value="{{ old('cust_name', $material->cust_name) }}">
                    @error('cust_name')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
                ...
                <div>
                    ...
                    <input type="text" id="stock" name="stock"
                        ...
                        placeholder="" autofocus value="{{ old('stock', $material->stock) }}">
                    @error('stock')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
