...
@section('title', 'Materials | Add Material')
@section('container')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/materials"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Materials</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">New
                        Material</a>
                </div>
            </li>
        </ol>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-5">
        <h1 class="font-semibold text-slate-700 text-xl mt-3 mb-7">New Material
        </h1>
        {{-- Form Body - BIODATA --}}
        <form method="post" action="/materials">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="cust_code" name="cust_code"
                        ...
                        placeholder="" autofocus value="{{ old('cust_code') }}">
                    @error('cust_code')
                ...
                <div>
                    ...
                    <input type="text" id="ai_code" name="ai_code"
                        ...
                        placeholder="" autofocus value="{{ old('ai_code') }}">
                    @error('ai_code')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
                ...
                <div>
                    ...
                    <input type="text" id="cust_name" name="cust_name"
                        ...
                        placeholder="" autofocus value="{{ old('cust_name') }}">
                    @error('cust_name')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
                ...
                <div>
                    ...
                    <input type="text" id="stock" name="stock"
                        ...
                        placeholder="" autofocus value="{{ old('stock') }}">
                    @error('stock')
                        <div class="text-red-700 mt-1 text-xs">
                            {{ $message }}
                        </div>
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    Submit
                </button>
            </div>
        </form>
