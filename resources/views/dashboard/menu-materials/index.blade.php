...
@section('container')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-5">
        ...
        @include('dashboard.menu-materials.partials.table')
    </div>

    <!-- Upload & Delete Modal -->
    @include('dashboard.menu-materials.partials.upload-modal')
    @include('dashboard.menu-materials.partials.delete-all-modal')


    {{-- ini adalah bagian untuk menampilkan SUCCESS ALERT & ERROR ALERT --}}
    @if (session()->has('success'))
        @include('dashboard.menu-materials.partials.alert-success')
    @endif
    @if (session()->has('importError'))
        @include('dashboard.menu-materials.partials.alert-error')
    @endif
